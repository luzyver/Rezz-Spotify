  ...
  >
    ...
    <div class="group/album relative mb-4">
      ...
      >
        ...
        >
          <div class="h-1.5 w-1.5 animate-pulse rounded-full" style="background-color: #ffffff;"></div>
          <span class="text-[10px] font-bold uppercase tracking-wide" style="color: #ffffff;">Live</span>
        </div>
      </a>
    </div>
    ...
    <div class="space-y-2">
      ...
      >
        <h3
          class="line-clamp-1 text-base font-bold text-white transition-colors hover:underline"
        >
          {buddy.track?.name || ''}
        </h3>
      </a>
